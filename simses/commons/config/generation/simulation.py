...
class SimulationConfigGenerator(ConfigGenerator):
    ...
    def set_grid_operation_strategy(self, strategy: str, 
                            fcr_power: float, ffr_power: float, vr_power:float, idm_power: float, 
                            fcr_reserve: float = 0.25, soc_set: float = 0.52) -> None:
        """
        ...
        """
        self.set_operation_strategy(strategy)
        self._set(EnergyManagementConfig.SECTION, EnergyManagementConfig.POWER_FCR, str(fcr_power))
        self._set(EnergyManagementConfig.SECTION, EnergyManagementConfig.POWER_FFR, str(ffr_power))
        self._set(EnergyManagementConfig.SECTION, EnergyManagementConfig.POWER_VR, str(vr_power))
