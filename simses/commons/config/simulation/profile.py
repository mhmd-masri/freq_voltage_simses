...
class ProfileConfig(SimulationConfig):
    ...
    VOLTAGE_PROFILE: str = 'VOLTAGE_PROFILE'
    ...
    def voltage_file(self) -> str:
        """Returns voltage profile file_name name from __analysis_config file_name"""
        return self.technical_profile_dir + self.get_property(self.SECTION, self.VOLTAGE_PROFILE)
