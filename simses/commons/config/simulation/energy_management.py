...
class EnergyManagementConfig(SimulationConfig):
    ...
    POWER_FFR: str = 'POWER_FFR'
    POWER_VR: str = 'POWER_FFR'
    ...
    @property
    def max_ffr_power(self) -> float:
        """Returns max power for providing frequency containment reserve from __analysis_config file_name"""
        return float(self.get_property(self.SECTION, self.POWER_FFR))

    @max_ffr_power.setter
    def max_ffr_power(self, value: float) -> None:
        self.set_property(self.SECTION, self.POWER_FFR, str(value))

    @property
    def max_VR_power(self) -> float:
        """Returns max power for providing frequency containment reserve from __analysis_config file_name"""
        return float(self.get_property(self.SECTION, self.POWER_VR))

    @max_VR_power.setter
    def max_VR_power(self, value: float) -> None:
        self.set_property(self.SECTION, self.POWER_VR, str(value))
