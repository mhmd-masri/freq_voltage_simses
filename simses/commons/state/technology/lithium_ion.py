...
class LithiumIonState(StorageTechnologyState):
    ...
    VOLTAGE_HYSTERESIS: str = 'Hysteresis voltage in V'
    ...
    @property
    def voltage_hysteresis(self) -> float:
        return self.get(self.VOLTAGE_HYSTERESIS)

    @voltage_hysteresis.setter
    def voltage_hysteresis(self, value: float) -> None:
        self.set(self.VOLTAGE_HYSTERESIS, value)
