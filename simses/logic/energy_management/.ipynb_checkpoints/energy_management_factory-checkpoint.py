...
class EnergyManagementFactory:
    ...
    def create_operation_strategy(self):
        ...
        if os == FrequencyContainmentReserve.__name__:
            ...
            self.__log.debug('Creating operation strategy as ' + os)
            return FFR1(self.__config_general, self.__config_ems)
        
        elif os == FFR2.__name__:
            self.__log.debug('Creating operation strategy as ' + os)
            return FFR2(self.__config_general, self.__config_ems)
        
        elif os == FFR3.__name__:
            self.__log.debug('Creating operation strategy as ' + os)
            return FFR3(self.__config_general, self.__config_ems)
        
        elif os == FFR4.__name__:
            self.__log.debug('Creating operation strategy as ' + os)
            return FFR4(self.__config_general, self.__config_ems)
