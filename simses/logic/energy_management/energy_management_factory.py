...
from simses.logic.energy_management.strategy.stacked.fcr_ffr1_idm_recharge_stacked import FcrFfr1IdmRechargeStacked
from simses.logic.energy_management.strategy.stacked.fcr_ffr2_idm_recharge_stacked import FcrFfr2IdmRechargeStacked
from simses.logic.energy_management.strategy.stacked.fcr_ffr3_idm_recharge_stacked import FcrFfr3IdmRechargeStacked
from simses.logic.energy_management.strategy.stacked.fcr_ffr4_idm_recharge_stacked import FcrFfr4IdmRechargeStacked
from simses.logic.energy_management.strategy.stacked.fcr_ffr_VR_idm_recharge_stacked import FcrFfrVRIdmRechargeStacked
from simses.logic.energy_management.strategy.stacked.semi_dynamic_multi_use import SemiDynamicMultiUse
from simses.logic.energy_management.strategy.basic.Fast_Frequency_Respone_FFR1 import FFR1
from simses.logic.energy_management.strategy.basic.Fast_Frequency_Respone_FFR2 import FFR2
from simses.logic.energy_management.strategy.basic.Fast_Frequency_Respone_FFR3 import FFR3
from simses.logic.energy_management.strategy.basic.Fast_Frequency_Respone_FFR4 import FFR4
from simses.logic.energy_management.strategy.basic.Voltage_Regulation_VR import VR
...
class EnergyManagementFactory:
    ...
    def create_operation_strategy(self):
        ...
        elif os == FFR1.__name__:
            self.__log.debug('Creating operation strategy as ' + os)
            return FFR1(self.__config_general, self.__config_ems, self.__config_profile)
        
        elif os == FFR2.__name__:
            self.__log.debug('Creating operation strategy as ' + os)
            return FFR2(self.__config_general, self.__config_ems, self.__config_profile)
        
        elif os == FFR3.__name__:
            self.__log.debug('Creating operation strategy as ' + os)
            return FFR3(self.__config_general, self.__config_ems, self.__config_profile)
        
        elif os == FFR4.__name__:
            self.__log.debug('Creating operation strategy as ' + os)
            return FFR4(self.__config_general, self.__config_ems, self.__config_profile)
        
        elif os == VR.__name__:
            self.__log.debug('Creating operation strategy as ' + os)
            return VR(self.__config_general, self.__config_ems, self.__config_profile)
        ...
        elif os == FcrFfr1IdmRechargeStacked.__name__:
            self.__log.debug('Creating operation strategy as ' + os)
            return FcrFfr1IdmRechargeStacked(self.__config_general, self.__config_ems, self.__config_profile,
                                         self.__config_system, self.__config_battery)
        
        elif os == FcrFfr2IdmRechargeStacked.__name__:
            self.__log.debug('Creating operation strategy as ' + os)
            return FcrFfr2IdmRechargeStacked(self.__config_general, self.__config_ems, self.__config_profile,
                                         self.__config_system, self.__config_battery)

        elif os == FcrFfr3IdmRechargeStacked.__name__:
            self.__log.debug('Creating operation strategy as ' + os)
            return FcrFfr3IdmRechargeStacked(self.__config_general, self.__config_ems, self.__config_profile,
                                         self.__config_system, self.__config_battery)

        elif os == FcrFfr4IdmRechargeStacked.__name__:
            self.__log.debug('Creating operation strategy as ' + os)
            return FcrFfr4IdmRechargeStacked(self.__config_general, self.__config_ems, self.__config_profile,
                                         self.__config_system, self.__config_battery)
        
        elif os == FcrFfrVRIdmRechargeStacked.__name__:
            self.__log.debug('Creating operation strategy as ' + os)
            return FcrFfrVRIdmRechargeStacked(self.__config_general, self.__config_ems, self.__config_profile,
                                         self.__config_system, self.__config_battery)
