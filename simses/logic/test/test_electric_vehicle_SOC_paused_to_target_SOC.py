...
SOC_VALUES: list = [1, 0.4, 0.5, 0.8, 0.8, 0.9, 0.9, 0.9]
BINARY_VALUES: list = [2, 0, 1, 1, 1, 1, 1, 0]
MAX_AC_POWER: int = 17
END: int = len(BINARY_VALUES)
EV_CHARGING_STRATEGY: str = 'Paused_to_target_SOC, 0.6'
...
@pytest.mark.parametrize('time, soc_state, capacity, result',
                         [
                            ...
                            (5, 0.8, 10, 17)                # 5: Departure is close => charge with max_AC
                         ]
                         )
