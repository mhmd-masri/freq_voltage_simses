...
from simses.logic.energy_management.strategy.basic import \
    peak_shaving_yapsa
from simses.logic.energy_management.strategy.serial import fcridm_peakshaving_serial
...
from simses.logic.power_distribution import secondlife_ac, \
    secondlife_dc, regulation_based_strategy, linear_optimized_strategy, new_test_distributor, optimized_strategy_new
from simses.logic.power_distribution.optimization_utils import particle_swarm_optimization
...
from simses.technology.lithium_ion.cell import litec_nmc as litec_nmc
...
from simses.technology.lithium_ion.degradation import nmc_akasol_oem as oem_degradation, \
    nmc_akasol_akm as akm_degradation, lfp_sony_gasper as sony_lfp_gasper_degradation, \
    nmc_samsung120ah as nmc_samsung120ah_degradation, nmc_litec as nmc_litec_degradation
from simses.technology.lithium_ion.degradation.calendar import nmc_akasol_akm as akm_calendar, \
    nmc_akasol_oem as oem_calendar, lfp_sony_gasper as sony_lfp_gasper_calendar, \
    nmc_samsung120ah as nmc_samsung120ah_calendar, nmc_litec as nmc_litec_calendar
from simses.technology.lithium_ion.degradation.cyclic import nmc_akasol_akm as akm_cyclic, \
    nmc_akasol_oem as oem_cyclic, lfp_sony_gasper as sony_lfp_gasper_cyclic, \
    nmc_samsung120ah as nmc_samsung120ah_cyclic, nmc_litec as nmc_litec_cyclic
...
proprietary_modules.append(particle_swarm_optimization)
proprietary_modules.append(litec_nmc)
proprietary_modules.append(nmc_litec_degradation)
proprietary_modules.append(nmc_litec_calendar)
proprietary_modules.append(nmc_litec_cyclic)
...
proprietary_modules.append(optimized_strategy_new)
