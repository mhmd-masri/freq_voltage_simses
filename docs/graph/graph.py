...
from simses.system.test import test_fix_cop_hvac, test_acdc_converter, test_location_ambient_temperature_profile_check, \
...
def create_ignore_list() -> str:
    ...
    ignore.append(test_location_ambient_temperature_profile_check)
